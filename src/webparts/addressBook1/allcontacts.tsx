...
export let people:Array<IPerson> = [{id:Guid.create().toString(),name:"Chandermani Arora",email:"chandermani@technovert.com",mobile:" 9292929292",landline:"040301231211",website:"http://www.technovert.com",address:"123 now here\nSome street\nMadhapur, Hyderabad 500033"},
